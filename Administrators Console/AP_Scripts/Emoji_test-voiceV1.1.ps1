...
while (!$exit) {
    ...
    Write-Host ""
    Write-Host "       A friend walks up and says `"Hey man...`"" -ForegroundColor white
    Write-Host ""
    Write-Host "  *************************************************" -ForegroundColor red
    Write-Host ""
    Write-Host "  Choose your response from the following options:" -ForegroundColor Blue
    ...
    switch ($selection) {
        ...
        2 {
            ...
            Write-Host ""
            Write-Host ""
            Write-Output "                          `u{1F4A9}"
            Write-Host ""
            Write-Host ""
            Write-Host "                         Loser!" -ForegroundColor red
